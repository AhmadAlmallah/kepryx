...
[evidence-lineage diagram](../diagrams/compliance-evidence-lineage.svg). Use only the synthetic
captures listed in the [product gallery](../PUBLICATION/PRODUCT-GALLERY.md).
